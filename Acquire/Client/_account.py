...
class Account:
    ...
    def __init__(self, account_name=None, user=None, accounting_service=None,
        ...
        if user is not None:
            ...
            self._account_uid = Account.get_account_uid(user, account_name,
                                                        accounting_service)
        else:
    ...
    @staticmethod
    def get_account_uid(user, account_name, accounting_service=None,
                        accounting_url=None):
    ...
    @staticmethod
    def get_account_uids(user, accounting_service=None, accounting_url=None):
    ...
    def get_accounts(user, accounting_service=None, accounting_url=None):
        ...
        """
        account_uids = Account.get_account_uids(
